...
func main() {
	...
	flag.IntVar(&maxPingWorkers, "maxPingWorkers", 2500, "The maximum amount of workers to ping IPs")
	flag.IntVar(&maxScanWorkers, "maxScanWorkers", 2500, "The maximum amount of workers to scan IPs")
